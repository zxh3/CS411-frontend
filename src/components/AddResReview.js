...
class AddResReview extends Component {
  ...
  render() {
    ...
    return (
      <div>
        <a className="btn-small wave-effect wave-light modal-trigger" href={`#${rand + this.props.resName}`}>add review</a>

        <div id={rand + this.props.resName} className="modal reviewRes">
